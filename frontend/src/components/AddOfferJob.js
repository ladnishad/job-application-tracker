...
class AddOfferJob extends React.Component{
  submitOfferJob(event){
  ...
  render() {
    return(
      <div align = 'center' className = "card text-white bg-success mb-3" style = {{width:"100%"}}>
      <form onSubmit = {this.submitOfferJob.bind(this)}>
