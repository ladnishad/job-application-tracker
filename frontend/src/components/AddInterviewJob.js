...
class AddInterviewJob extends React.Component{
  submitInterviewJob(event){
  ...
  render() {
    return(
      <div align = 'center' className = "card text-white bg-secondary mb-3" style = {{width:"100%"}}>
      <form onSubmit = {this.submitInterviewJob.bind(this)}>
...
export default AddInterviewJob
