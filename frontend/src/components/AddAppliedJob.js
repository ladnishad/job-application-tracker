...
class AddAppliedJob extends React.Component{
  ...
  render() {
    return(
      <div align = 'center' className = "card bg-light mb-3" style = {{width:"100%"}}>
      <form onSubmit = {this.submitAppliedJob.bind(this)}>
